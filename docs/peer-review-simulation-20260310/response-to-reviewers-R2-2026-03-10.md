...
We thank the three reviewers for their positive reassessment and for confirming that the major concerns from Round 1 have been resolved. All three now recommend minor revision. Below we describe the changes made for the eight remaining items, organised by reviewer convergence. All changes have been implemented in the manuscript.
...
**Change made:** Added a paragraph to the introduction's methodological section:
...
**Change made:** Added to §4.1, after the existing sentence on overlap:
...
**Change made:** Added to §4.4, after the bimodality description:
...
**Change made:** Added a footnote in §3.1, after the MDB joint tracking passage:
...
**Change made:** Added a sentence in §4.3 after the Star & Griesemer discussion:
...
The concluding mention now back-references §4.3: "As noted in §4.3, Dahan (2010) has shown…"
...
**Change made:** Revised the sentence in §4.4:
...
**Change made:** In §4.2, added a parenthetical after "MacKenzie's Barnesian performativity":

> (the strongest form in his taxonomy of generic, effective, and Barnesian performativity)
...
**Change made:** Added to the limitations paragraph in the conclusion:
...
## Items noted but not addressed in this revision
...
- **Post-2024 ETF/NCQG developments** (R2 item c): The first biennial transparency reports are due December 2024; as of our submission date, no comprehensive assessment of their impact on measurement categories has been published. We would add a sentence noting this if the editor considers it necessary.
- **Foucauldian footnote** for "governable object" (R3): R3 calls it "prudent but not essential." We would add a brief footnote acknowledging the resonance with Miller & Rose without adopting the full governmentality apparatus, if requested.
...
Net word count after changes: ~8,750 words. Well within typical Œconomia limits.

All changes have been implemented. No structural revision was required.
