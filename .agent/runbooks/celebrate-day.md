...
8. **Memory sweep** — follow `.agent/runbooks/memory.md` (includes runbook cross-reference).
...
10. **Autonomous session** — if the user wants to launch an autonomous session,
    hand off to `.agent/runbooks/autonomous-session.md`. The end-of-day celebration is the
