...
**This file MUST remain a lean index.** All substance lives in the files below.
Do NOT add project structure, data paths, conventions, or guidelines here.

- README.md — project overview, repository structure, data paths, contact
