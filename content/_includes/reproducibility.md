...
| `compute_alluvial.py` | `refined_works.csv`, `refined_embeddings.npz` | `tab_alluvial.csv`, `tab_breakpoints.csv`, `tab_breakpoint_robustness.csv`, `cluster_labels.json`, `tab_core_shares.csv`; with `--lexical`: `tab_lexical_tfidf.csv` + `fig_lexical_tfidf_*.png` |
