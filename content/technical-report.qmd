...
|--------|---------|---------|
| **Field convergence** | S1–S4, L1, L2, G1, G9 | Peak Z ≈ +2–4 around 1998–2002; monotonic decline thereafter. Early climate finance was heterogeneous; the field homogenised over time. |
...
| **Noisy / cumulative** | G3, G4, G7, G8, C2ST | Weak or non-directional signal; useful as robustness checks. |
...
<!-- TODO: schematic showing two overlapping Gaussians with kernel RKHS witness function -->
*[Figure placeholder: two 2-D embedding clouds with kernel witness function shown as contour.]*
...
<!-- TODO: fig_zoo_S1.pdf — time series with bootstrap CI, sensitivity panel (w=2,3,4,5) -->
*[Figure placeholder: cross-year Z-score panel, w=2–5, with bootstrap 90% CI.]*

Key values (w=3): peak $Z = +4.2$ at 1998, monotonic decline to $Z \approx -1.0$ by 2010.
...
<!-- TODO: schematic — two 1-D Gaussian densities; arrows show within-group vs between-group distances -->
*[Figure placeholder: 1-D Gaussian pair illustrating within-group vs between-group pairwise distances.]*
...
<!-- TODO: fig_zoo_S2.pdf -->
*[Figure placeholder: cross-year Z-score time series, w=2–5, bootstrap 90% CI.]*

Cross-year $Z$-scores (w=3) show a monotonic decline from $Z = +3.9$ at 1998 to $Z = -1.5$ at 2010 (Figure [TODO]).
...
*[Figure placeholder: schematic showing 1-D projections onto two random directions with sorted quantile comparison.]*
...
*[Figure placeholder: cross-year Z-score panel.]*

Key values (w=3): peak $Z = +3.6$ at 1998, monotonic decline. Pattern identical to S2.
...
*[Figure placeholder: two 2-D Gaussian ellipses with Fréchet distance illustrated.]*
...
*[Figure placeholder: two vocabulary distributions (bar chart) with mixed distribution $M$ and divergence arrows.]*
...
*[Figure placeholder: timeline with arrows for novelty (backward KL) and transience (forward KL); resonance = difference.]*
...
*[Figure placeholder: novelty, transience, resonance time series (w=3), with 90% CI.]*
...
*[Figure placeholder: frequency time series for two terms, one bursting, with threshold line.]*
...
*[Figure placeholder: number of bursting terms per year, with top-10 terms annotated at 2007 and 2013.]*
...
*[Figure placeholder: two PageRank histograms (log-log scale) before/after a break, with JS divergence illustrated.]*
...
*[Figure placeholder: cross-year Z-score panel, w=2–5.]*
...
*[Figure placeholder: two graphs with different spectral gaps; eigenvalue spectrum comparison.]*
...
*[Figure placeholder: reference age distribution shifting over time.]*
...
*[Figure placeholder: reference age shift per year, 1990–2024.]*
...
*[Figure placeholder: bipartite graph between three tradition clusters with cross-edges highlighted.]*
...
*[Figure placeholder: cross-tradition ratio, 1990–2024.]*
...
*[Figure placeholder: log-log degree distribution before/after with two power-law fits showing different slopes.]*
...
*[Figure placeholder: cross-year Z-score panel, w=2–5, bootstrap 90% CI.]*

**Key result:** Cross-year $Z$-scores (w=3) peak at **2007** ($Z = +2.96$), with a secondary plateau around 2013–2015 ($Z \approx +1.5$).
...
*[Figure placeholder: two in-degree distributions with entropy values annotated — one concentrated (low $H$), one dispersed (high $H$).]*
...
*[Figure placeholder: three classes of subsequent citers ($f$, $b$, $c$) illustrated as citation network around paper $i$.]*
...
*[Figure placeholder: mean annual CD index, 1990–2015 (2016+ censored).]*
...
*[Figure placeholder: small network with one high-betweenness bridge node highlighted.]*
...
*[Figure placeholder: force-directed layout with community colours, before vs after panel, JS divergence annotated.]*
...
*[Figure placeholder: C2ST accuracy time series for embedding and lexical, w=3, with 95% binomial CI.]*
