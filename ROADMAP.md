...
- Fuzzy ref matching (#539): GROBID-parsed citation refs matched to corpus works via rapidfuzz, new `ref_match` DVC stage, integrated into `corpus_corpus_merge_citations`
