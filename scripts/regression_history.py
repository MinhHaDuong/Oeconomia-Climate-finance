...
Usage:
    uv run python scripts/regression_history.py --commits <sha1> <sha2> ...
    uv run python scripts/regression_history.py --range <start>..<end>
    uv run python scripts/regression_history.py --since-smoke
