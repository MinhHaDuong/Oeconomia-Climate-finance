...
METHODS = {
    ...
    "S3_sliced_wasserstein":("_divergence_semantic",  "compute_s3_wasserstein","semantic",  True,  False),
    "S4_frechet":           ("_divergence_semantic",  "compute_s4_frechet",    "semantic",  True,  False),
    ...
    "G1_pagerank":          ("_divergence_citation",  "compute_g1_pagerank",   "citation",  False, True),
    "G2_spectral":          ("_divergence_citation",  "compute_g2_spectral",   "citation",  False, True),
    "G3_coupling_age":      ("_divergence_citation",  "compute_g3_age_shift",  "citation",  False, True),
    "G4_cross_tradition":   ("_divergence_citation",  "compute_g4_cross_trad", "citation",  False, True),
    "G5_pref_attachment":   ("_divergence_citation",  "compute_g5_pa_exponent","citation",  False, True),
    "G6_entropy":           ("_divergence_citation",  "compute_g6_entropy",    "citation",  False, True),
    "G7_disruption":        ("_divergence_citation",  "compute_g7_disruption", "citation",  False, True),
    "G8_betweenness":       ("_divergence_citation",  "compute_g8_betweenness","citation",  False, True),
}
