...
class TestDvcYamlIntegration:
    ...
    def test_catalog_teaching_stage_deps_include_syllabi(self):
        """The catalog_teaching stage should depend on data/syllabi, not config/teaching_sources.yaml."""
        ...
        assert "config/teaching_sources.yaml" not in deps, \
            "catalog_teaching should NOT depend on config/teaching_sources.yaml"
